...
function Principal() {
    return (
        ...
        <>
            ...
            <div id="home" className="w-full bg-[#B1C4AE] text-black relative pb-20">
        ...
        // Container Principal: organiza os dois blocos de produto verticalmente */}
            <div id="produtos" className="flex flex-col items-center gap-16 bg-white py-20 relative pb-20">
                    ...
                    <div className="flex flex-col items-center gap-y-10 mb-16">
                        ...
                        <div className="flex flex-wrap justify-center gap-10 md:gap-20">
                            ...
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <p className="text-black">Dev Fullstack que ama viajar</p>
                                <div className="flex gap-2">
                                    <a href="https://www.linkedin.com/in/larissa-santana-a0b9a02b7/" target="_blank">
                                        <LinkedinLogoIcon size={30} weight="regular" />
                                    </a>

                                    <a href="https://github.com/Santana-larissa" target="_blank">
                                        <GithubLogoIcon size={30} weight="regular" />
                                    </a>
                                </div>
                            </div>
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <p className="text-black">Dev Fullstack e fitness girl</p>
                                <div className="flex gap-2">
                        ...
                        <div className="flex flex-wrap justify-center gap-10 md:gap-20">
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <p className=" text-black">Dev Fullstack que ama girar cubos</p>
                                <div className="flex gap-2">
                                    <a href="https://linkedin.com/in/matheusschneider" target="_blank">
                                        <LinkedinLogoIcon size={30} weight="regular" />
                                    </a>

                                    <a href="https://github.com/matheusschneider1" target="_blank">
                                        <GithubLogoIcon size={30} weight="regular" />
                                    </a>
                                </div>
                            </div>
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <p className="text-black">Dev Fullstack que ama pokémon</p>
                                <div className="flex gap-2">
                                    <a href="https://www.linkedin.com/in/pedro-elias-4b5ab4181" target="_blank">
                                        <LinkedinLogoIcon size={30} weight="regular" />
                                    </a>

                                    <a href="https://github.com/pedro-eliasd" target="_blank">
                                        <GithubLogoIcon size={30} weight="regular" />
                                    </a>
                                </div>
                            </div>
